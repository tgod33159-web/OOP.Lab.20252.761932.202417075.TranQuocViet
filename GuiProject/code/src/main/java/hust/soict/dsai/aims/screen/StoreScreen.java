...
public class StoreScreen extends JFrame {
    ...
    JMenuBar createMenuBar() {
        ...
        addBook.addActionListener(e -> openAddScreen("book"));
        JMenuItem addCd = new JMenuItem("Add CD");
        addCd.addActionListener(e -> openAddScreen("cd"));
        JMenuItem addDvd = new JMenuItem("Add DVD");
        addDvd.addActionListener(e -> openAddScreen("dvd"));
    ...
    private void openAddScreen(String type) {
        try {
            if ("book".equals(type)) {
