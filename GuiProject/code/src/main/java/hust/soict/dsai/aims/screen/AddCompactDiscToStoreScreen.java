...
public class AddCompactDiscToStoreScreen extends AddItemToStoreScreen {
    ...
    public AddCompactDiscToStoreScreen(Store store, Cart cart) {
        ...
        initializeScreen("Add CD");
    }

    public AddCompactDiscToStoreScreen(Store store, Cart cart, StoreScreen owner) {
        super(store, cart, "Add CD", owner);
        initializeScreen("Add CD");
    }
    ...
    protected Media createMedia() {
        CompactDisc cd = new CompactDisc(readId(), tfTitle.getText().trim(),
                tfCategory.getText().trim(), readCost(), tfDirector.getText().trim(), 0,
